...
const UserReinF = () => {
  return (
    <div className="user-rein-f">
      <div className="text-wrapper">회원 정보 수정</div>
      ...
      <div className="user-re-regist-com">
        <button className="button">
          <button className="button-2">정보 수정 완료</button>
        </button>
      </div>
    </div>
  );
